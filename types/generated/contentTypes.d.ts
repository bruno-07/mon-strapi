...
export interface ApiAdresseAdresse extends Struct.CollectionTypeSchema {
...
export interface ApiAviAvi extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::avi.avi'> &
      Schema.Attribute.Private;
...
export interface ApiCommandeCommande extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mode_paiement: Schema.Attribute.Enumeration<
      ['orange money', 'Mtn mobile money', 'UBA']
    >;
    montant_total: Schema.Attribute.Decimal;
    numero_suivi: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    statut: Schema.Attribute.Enumeration<
      ['en attente', 'completer', 'annuler']
    >;
    statut_paiement: Schema.Attribute.Enumeration<
      ['compl\u00E9ter', 'en attente', 'annuler']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLigneCommandeLigneCommande
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    panier: Schema.Attribute.Relation<'manyToOne', 'api::panier.panier'>;
    prix_total_ligne: Schema.Attribute.Decimal;
    prix_unitaire: Schema.Attribute.Decimal;
    produit: Schema.Attribute.Relation<'manyToOne', 'api::produit.produit'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiLignesPanierLignesPanier
  extends Struct.CollectionTypeSchema {
  collectionName: 'lignes_paniers';
  info: {
    displayName: 'lignes_panier';
    pluralName: 'lignes-paniers';
    singularName: 'lignes-panier';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::lignes-panier.lignes-panier'
    > &
      Schema.Attribute.Private;
    produit: Schema.Attribute.Relation<'manyToOne', 'api::produit.produit'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPanierPanier extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    date_derniere_mise_a_jour: Schema.Attribute.Date;
    ligne_commandes: Schema.Attribute.Relation<
      'oneToMany',
      'api::ligne-commande.ligne-commande'
    >;
    ...
    publishedAt: Schema.Attribute.DateTime;
    statut: Schema.Attribute.Enumeration<
      ['Actif', 'Converti', 'Abandonn\u00E9', 'Expir\u00E9']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProduitProduit extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ligne_commandes: Schema.Attribute.Relation<
      ...
      'api::ligne-commande.ligne-commande'
    >;
    lignes_paniers: Schema.Attribute.Relation<
      'oneToMany',
      'api::lignes-panier.lignes-panier'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
